...
MAX_NODES = 5000
GOAL_THRESHOLD = 0.5
MAX_CONNECTION_DISTANCE = 2.0  # Maximum step size for connecting nodes
NUM_INITIAL_BRANCHES = 10      # Increased branching from the root
GOAL_BIAS = 0.1                # 10% of samples directed toward the goal
ENVIRONMENT_BOUNDS = 10        # Size of the environment (-10 to 10 in x/y)
...
def bicycle_step(state, velocity, steering_angle, dt=DT):
    x, y, theta = state
    theta += velocity / TURNING_RADIUS * np.tan(steering_angle) * dt
